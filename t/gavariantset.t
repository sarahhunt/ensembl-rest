...
my $post_data1  = '{ "pageSize": 2 }';
my $post_data1a = '{ "pageSize": 2,  "datasetId": ""}';
my $post_data2  = '{ "pageSize": 2,  "datasetId":1,"pageToken":"" }';                                            
...
my $json1a = json_POST( $base, $post_data1a, 'variantset - 2 entries, null dataset' );
eq_or_diff($json1, $expected_data1, "Checking the result from the gavariantset endpoint");
